...
import dgl
from ALARM_utils import get_parse, train_step, test_step, normalize_adj
...
if __name__ == '__main__':
    ...
    model = ALARM(feat_size=features.shape[1], hidden_size=args.hidden_dim,
                  dropout=args.dropout, view_num=args.view_num, agg_type=args.view_num, 
